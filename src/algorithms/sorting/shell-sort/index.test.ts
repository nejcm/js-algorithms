...
describe('ShellSort', () => {
  ...
  it('should visit NOT SORTED array element specified number of times', () => {
    Tester.testComplexity(shellSort, notSortedArr, NOT_SORTED_ARRAY_VISITING_COUNT);
  });

  it('should visit REVERSE SORTED array element specified number of times', () => {
    Tester.testComplexity(shellSort, reverseArr, REVERSE_SORTED_ARRAY_VISITING_COUNT);
  });
});
