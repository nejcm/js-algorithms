...
Other well-known algorithms for this problem include Kruskal's algorithm and
...
meeting or improving the time bounds for other algorithms. [Source: Wikipedia]
...
spanning trees for its connected components. [Source: Wikipedia]
