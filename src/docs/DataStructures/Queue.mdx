---
name: Queue
route: /data-structures/queue
menu: All data structures
---

# Queue

Is a collection of entities that are maintained in a sequence and can be
...
The operations of a queue make it a first-in-first-out (FIFO) data structure. In
