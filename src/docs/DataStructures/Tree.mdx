...
1. Binary Tree: This is the most basic basic from of tree structure. Where each
   ...
   possible. In the infinite complete binary tree, every node has two children.
...
3. AVL tree or height balanced binary tree: It is a variation of the Binary tree
   ...
   the operation.
4. Red-Black tree: Another variant of binary tree similar to AVL tree it is a
...
9. Suffix tree: Trie and suffix tree are closely related. a suffix tree (also
...
10. Huffman Tree: Huffman tree is a frequency sorted binary tree used widely in
    ...
    to a long text based on its frequency of occurrences.
11. Heap Structure [Edit as suggested]: Heap structure is another widely used
