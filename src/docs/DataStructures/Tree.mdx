...
8. Suffix tree: Trie and suffix tree are closely related. a suffix tree (also
...
9. Huffman Tree: Huffman tree is a frequency sorted binary tree used widely in
...
10. Heap Structure [Edit as suggested]: Heap structure is another widely used
