---
name: Bloom filter
route: /data-structures/bloom-filter
...
of a set. False positive matches are possible, but false negatives are not – in
...
larger the probability of false positives. (Source: Wikipedia)
