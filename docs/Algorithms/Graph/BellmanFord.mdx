...
[View the implementation](https://github.com/nejcm/js-algorithms/blob/master/src/algorithms/graph/bellman-ford/index.ts)

It is an algorithm that computes shortest paths from a single source vertex to all of the
...
Like Dijkstra's algorithm, Bellman–Ford proceeds by relaxation, in which approximations to
