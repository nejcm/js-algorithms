...
[View the implementation](https://github.com/nejcm/js-algorithms/blob/master/src/algorithms/graph/dijkstra/index.ts)
...
city and all other cities. [Source: Wikipedia]
