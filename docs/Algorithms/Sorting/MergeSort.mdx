...
[View the implementation](https://github.com/nejcm/js-algorithms/blob/master/src/algorithms/sorting/merge-sort/index.ts)
...
A recursive merge sort algorithm used to sort an array of 7 integer values. These are the
