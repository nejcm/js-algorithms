...
[View the implementation](https://github.com/nejcm/js-algorithms/blob/master/src/algorithms/sorting/tim-sort/index.ts)
...
We divide the Array into blocks known as Run. We sort those runs using insertion sort one
