...
[View the implementation](https://github.com/nejcm/js-algorithms/blob/master/src/algorithms/sorting/selection-sort/index.ts)
...
The time efficiency of selection sort is quadratic, so there are a number of sorting
