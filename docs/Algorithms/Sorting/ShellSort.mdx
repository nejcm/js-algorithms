...
[View the implementation](https://github.com/nejcm/js-algorithms/blob/master/src/algorithms/sorting/shell-sort/index.ts)

Also known as Shell sort or Shell's method, is an in-place comparison sort. It can be seen
